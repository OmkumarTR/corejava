...
public class AttributesDemo extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		 ...
		 * If a user modifies the value of the global variable, then all other users currently using 
		 * the servlet or users who may the servlet in the future will get the last modified value.
